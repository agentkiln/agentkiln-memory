...
- Authentication: Bearer token or `X-Api-Key` with the submitted Memory System Key
...
- Memory System Key delivery through the organizer's controlled request flow
